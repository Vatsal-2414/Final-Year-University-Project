...
double precision dr(1:3), rad2, AU, yr, com(1:3), cov(1:3), mtot, KE, PE, Ei, Ecurr, delE, rad, tcount,textracount, dsun(1:8)
...
!write(6,*) '****************'
!write(6,*) 'after bootstrap:'
!write(6,*) 'v jup - v(2,2,-4:0)= ',v(2,2,-4:0)/1000.
!write(6,*) '****************'
...
!OPEN(3,file='xypos_5_1000yrs_adaptive_dt.txt',status='new')
!open(5,file='encheck_1000yrs_adaptive_dt1000_new.txt',status='new')
!open(3,file='dsun_1000yrs_adaptive_dt_1000.txt',status='new')
!open(2,file='dt_2.txt',status='new')

!write(6,*) 'Starting the predictor-corrector'
do
...
!        write(6,*) '$$$$$$$$$$$$$$$$$$$$'
!        write(6,*) 'dsun_earth =',dsun(3)/AU
!        write(6,*) 'tcurr=',tcurr/yr
!        write(3,*) tcurr/yr,dsun(1:n)/AU

        tcount = 0.

    end if
    !------------
!    if(textracount<(5.*yr)) then
!        write(2,*) textracount/yr,dt
!        !textracount = 0.
!    end if
    ...
    if(max(err_r,err_v)>relerr) Then  !finds the maximum error contribution from the position or velocity
        dt = dt*0.5
!        write(6,*) '!------Halving------!',dt
!        write(6,*) '-----before shifting elements-----'
!        write(6,*) 'r jup = ',r(1,2,-8:0)/AU
!        write(6,*) '            '
        !New past steps are introduced.
        do i=1,n
            !This is the t=-1/2 step.
            r_newpast(1:3,i,-1) = (-5.*r(1:3,i,-4) + 28.*r(1:3,i,-3) - 70.*r(1:3,i,-2) + 140.*r(1:3,i,-1) + 35.*r(1:3,i,0))/128.
            ...
            r_newpast(1:3,i,-3) = (3.*r(1:3,i,-4) - 20.*r(1:3,i,-3) + 90.*r(1:3,i,-2) + 60.*r(1:3,i,-1) - 5.*r(1:3,i,0))/128.
        ...
        do i=1,n
            r(1:3,i,-4) = r(1:3,i,-2)   !the -2 step going into the -4 paststep
            v(1:3,i,-4) = v(1:3,i,-2)
            a(1:3,i,-4) = a(1:3,i,-2)

            r(1:3,i,-2) = r(1:3,i,-1)     !the -1 step becomes the new -2 paststep
            v(1:3,i,-2) = v(1:3,i,-1)
            a(1:3,i,-2) = a(1:3,i,-1)

            r(1:3,i,-1) = r_newpast(1:3,i,-1)  !the -1/2 step going into -1 step.
            v(1:3,i,-1) = v_newpast(1:3,i,-1)
            a(1:3,i,-1) = a_newpast(1:3,i,-1)

            r(1:3,i,-3) = r_newpast(1:3,i,-3)   !the -3/2 step going into the -3 paststep
...
!        write(6,*) '----timestep halved----', dt
!        write(6,*) 'r_newpast(1,2,-1) = ',r_newpast(1,2,-1)/AU
!        write(6,*) 'r_newpast(1,2,-3) = ',r_newpast(1,2,-3)/AU
!        write(6,*) '            '
!        write(6,*) 'r jup = ',r(1,2,-8:0)/AU
!        write(6,*) '            '
!        write(6,*) '            '
...
!            write(6,*) '            '
            do i=1,n
                r(1:3,i,-1) = r(1:3,i,-2)   !the -2 step becomes the new -1 paststep
                v(1:3,i,-1) = v(1:3,i,-2)
                a(1:3,i,-1) = a(1:3,i,-2)

                r(1:3,i,-2) = r(1:3,i,-4)   !the -4 step becomes the new -2 paststep
                v(1:3,i,-2) = v(1:3,i,-4)
                a(1:3,i,-2) = a(1:3,i,-4)

                r(1:3,i,-3) = r(1:3,i,-6)   !the -6 step becomes the new -3 paststep
                v(1:3,i,-3) = v(1:3,i,-6)
                a(1:3,i,-3) = a(1:3,i,-6)

                r(1:3,i,-4) = r(1:3,i,-8)
                v(1:3,i,-4) = v(1:3,i,-8)   !the -8 step becomes the new -4 paststep
                a(1:3,i,-4) = a(1:3,i,-8)
            ...
            counter = 0
!            write(6,*) '------shifting after doubling------', dt
!            write(6,*) 'r jup = ',r(1,2,-8:0)/AU
!            write(6,*) '            '
!            write(6,*) '            '
        end if
    !counter for allowing to double after four iterations.
    counter = counter + 1
    end if
...
!    write(6,*) '#-----after downshifting------#:', dt
!    write(6,*) 'r_c jup = ',r_c(1,2,1)/AU
!    write(6,*) 'r jup = ',r(1,2,-8:0)/AU
!    write(6,*) '            '
!    write(6,*) '            '
!    write(6,*) '            '
